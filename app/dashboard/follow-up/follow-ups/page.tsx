    ...
    return (
        <div className="space-y-6">
                ...
                <CardContent>
                    {loading ? (
                        ...
                        <div className="space-y-3">
                            {followUps.map((fu) => (
                                <div key={fu.id} className="flex items-center justify-between p-4 border rounded-lg">
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm text-gray-600">
                                            ...
                                            <span>Delay: {fu.delay || 0} dia(s) • </span>
            ...
            <ConfirmDialog
                ...
                message="Tem certeza? As execuções pendentes serão canceladas."
            />
        </div>
    );
}
